            ...
            SizedBox(
              height: size.height * 0.08,
                      ...
                      Row(
                        ...
                        children: [
                          Text("already have an account?",style: TextStyle(color: Colors.lightBlueAccent,fontWeight: FontWeight.bold,fontSize: 16),),
                          GestureDetector(
                              onTap: ()
                              {
                              ...
                              child: Text("Signin",style: TextStyle(color: Colors.blue,fontWeight: FontWeight.bold,fontSize: 18),)),
